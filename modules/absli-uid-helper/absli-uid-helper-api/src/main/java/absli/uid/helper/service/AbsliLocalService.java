...
/**
 * Provides the local service interface for Absli. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AbsliLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AbsliLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>absli.uid.helper.service.impl.AbsliLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the absli local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AbsliLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Absli add(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Absli> getAbslisByUuidAndCompanyId(String uuid, long companyId);
	...
	public Absli update(
			...
			String createdBy, ServiceContext serviceContext)
		throws PortalException;
